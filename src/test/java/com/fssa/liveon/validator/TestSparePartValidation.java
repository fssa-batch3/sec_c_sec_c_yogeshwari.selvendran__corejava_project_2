...
class TestSparePartValidation {
	...
	void testValidateProduct() {
		...
		// object
		Assertions.assertTrue(SparePartValidation.validateProduct(product));
	}
	...
	void testInvaidProduct() {
		try {
			...
			SparePartValidation.validateProduct(null);
...
//	Valid test case for Product Name
	...
	void testValidProductName() {
		...
		// Product object
		Assertions.assertTrue(SparePartValidation.validateProductName(productName));
	}
...
//	Invalid test case for product name
	...
	void testInvalidProductName() {
		try {
			// Validating a null Product object should throw an
			// InvalidProductDetailsException
			SparePartValidation.validateProductName(null);
			Assertions.fail("Test case failed");
		} catch (InvalidSparePartDetailsException e) {
			// Asserting that the exception message matches the expected error message
		...
		try {
			...
			// InvalidProductDetailsException
			SparePartValidation.validateProductName("u");
			Assertions.fail("Test case failed");
		} catch (InvalidSparePartDetailsException e) {
			// Asserting that the exception message matches the expected error message
...
//	Valid test case for product price
	...
	void validProductPrice() {
		...
		// Product object
		Assertions.assertTrue(SparePartValidation.validateProductPrice(productPrice));
	}
...
//	Invalid test case for product price
	...
	void inValidProductPrice() {
		try {
			...
			SparePartValidation.validateProductPrice(0);
		} catch (InvalidSparePartDetailsException e) {
			// Asserting that the exception message matches the expected error message
...
// 	Valid test case for product rating
	...
	void validProductRating() {
		...
		// Product object
		Assertions.assertTrue(SparePartValidation.validateProductRating(rating));
	}
...
//	Invalid test case for product rating 
	...
	void inValidProductRating() {
		try {
			...
			// InvalidProductDetailsException
			SparePartValidation.validateProductRating(-2);
		} catch (InvalidSparePartDetailsException e) {
			// Asserting that the exception message matches the expected error message
...
//	Valid test case for Product Description
	...
	void testValidProductDescription() {
		...
		// Product object
		Assertions.assertTrue(SparePartValidation.validateProductDescription(description));
	}
...
//	Invalid test case for  product Description
	...
	void testInvalidProductDescription() {
		try {
			// Validating a null Product object should throw an
			// InvalidProductDetailsException
			SparePartValidation.validateProductDescription(null);
		...
		try {
			...
			// InvalidProductDetailsException
			SparePartValidation.validateProductDescription("yib");
			Assertions.fail("Tset case failed");
		} catch (InvalidSparePartDetailsException e) {
			// Asserting that the exception message matches the expected error message
...
//	Valid image url test case
	void testImageUrl() {
		...
		// Product object
		Assertions.assertTrue(SparePartValidation.productImagesValidator(validImages));
	}
...
//	Invalid image Url  test case
	void inValidImageUrl() {
		...
		try {
			// Validating a null Product object should throw an
			// InvalidProductDetailsException
			SparePartValidation.productImagesValidator(null);
			Assertions.fail("Test case failed");
		} catch (InvalidSparePartDetailsException e) {
			// Asserting that the exception message matches the expected error message
		...
		try {
			SparePartValidation.productImagesValidator(invalidImages);
			Assertions.fail("Test case failed");
		} catch (InvalidSparePartDetailsException e) {
			// Asserting that the exception message matches the expected error message
...
//	Valid product id
	...
	void validProductId() {
		...
		// object
		Assertions.assertTrue(SparePartValidation.productIdValidate(1));
	}
...
//	Invalid product Id 
	void inValidProductId() {
		try {
			...
			SparePartValidation.productIdValidate(-1);
		} catch (InvalidSparePartDetailsException e) {
