...
public class SparePartValidationsErrors {
	
	
	private SparePartValidationsErrors() {
		//private constructor
	}
...
//	Invalid product price
	public static final String INVALID_PRODUCTPRICE = "Product price should be  greater than or equal to 100  and lesser then or equal to 30000";
//	product rating
