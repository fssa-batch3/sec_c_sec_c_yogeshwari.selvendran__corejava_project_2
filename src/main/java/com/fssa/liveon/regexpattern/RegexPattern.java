...
//		private constructor
	...
	public static final String USER_FIRST_NAME_REGEX = "^[A-Za-z]{2,30}$";
	public static final String USER_LAST_NAME_REGEX = "^[A-Za-z]{1,30}$";
	public static final String USER_EMAIL_REGEX = "^[A-Za-z0-9+_.-]+@[^\\s]+\\.(.+)$";
